...
var instrucciones = ["Mueva las piezas utilizando las flechas del teclado", "Acomode las piezas para formar la imagen original"];
...
function mostrarInstrucciones(instrucciones) {
  for (var i = 0; i <= instrucciones.length - 1; i++) {
...
function intercambiarPosicionesGrilla(filaPos1, columnaPos1, filaPos2, columnaPos2) {
  var p = grilla[filaPos1][columnaPos1];
  grilla[filaPos1][columnaPos1] = grilla[filaPos2][columnaPos2];
  grilla[filaPos2][columnaPos2] = p;
}
...
function moverEnDireccion(direccion) {
  ...
  if (posicionValida(nuevaFilaPiezaVacia, nuevaColumnaPiezaVacia)) {
    ...
    //COMPLETAR: Agregar la dirección dagreugarel movimiento al arreglo de movimientos
